...
const (
	CurrencyConverter_ConvertCurrency_FullMethodName = "/grpc_package.CurrencyConverter/ConvertCurrency"
)
...
type CurrencyConverterClient interface {
	ConvertCurrency(ctx context.Context, in *CurrencyRequest, opts ...grpc.CallOption) (*CurrencyResponse, error)
}
...
func (c *currencyConverterClient) ConvertCurrency(ctx context.Context, in *CurrencyRequest, opts ...grpc.CallOption) (*CurrencyResponse, error) {
...
type CurrencyConverterServer interface {
	ConvertCurrency(context.Context, *CurrencyRequest) (*CurrencyResponse, error)
...
func (UnimplementedCurrencyConverterServer) ConvertCurrency(context.Context, *CurrencyRequest) (*CurrencyResponse, error) {
...
func _CurrencyConverter_ConvertCurrency_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CurrencyConverterServer).ConvertCurrency(ctx, req.(*CurrencyRequest))
	}
...
var CurrencyConverter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_package.CurrencyConverter",
